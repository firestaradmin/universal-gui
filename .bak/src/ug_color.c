...
ug_color_t ug_color_hsv_to_rgb(uint16_t h, uint8_t s, uint8_t v)
{
    ...
    ug_color_t result = ug_color_make(r, g, b);
    return result;
}
...
{
    ug_color32_t color32;
    color32.full = ug_color_to32(color);
    return ug_color_rgb_to_hsv(color32.ch.red, color32.ch.green, color32.ch.blue);
}
