...
#define UGUI_DEV_NUM	2

/* Represents the size required for the color of a pixel   
   if your screen is mono, the screen_Color_bitNum need to be init as 1;*/
#define UGUI_COLOR_DATA_BITS  16	//unit:bit



#if(UGUI_COLOR_DATA_BITS == 1)
	#define UGUI_COLOR_BLACK  0
	#define UGUI_COLOR_WHITE  1
#elif (UGUI_COLOR_DATA_BITS == 16)
	//画笔颜色
	#define UGUI_COLOR_WHITE         	 0xFFFF
	#define UGUI_COLOR_BLACK         	 0x0000	  
	#define UGUI_COLOR_BLUE         	 0x001F  
	#define UGUI_COLOR_BRED             0XF81F
	#define UGUI_COLOR_GRED 			 0XFFE0
	#define UGUI_COLOR_GBLUE			 0X07FF
	#define UGUI_COLOR_RED           	 0xF800
	#define UGUI_COLOR_MAGENTA       	 0xF81F
	#define UGUI_COLOR_GREEN         	 0x07E0
	#define UGUI_COLOR_CYAN          	 0x7FFF
	#define UGUI_COLOR_YELLOW        	 0xFFE0
	#define UGUI_COLOR_BROWN 			 0XBC40 //棕色
	#define UGUI_COLOR_BRRED 			 0XFC07 //棕红色
	#define UGUI_COLOR_GRAY  			 0X8430 //灰色
	//GUI颜色
	#define UGUI_COLOR_DARKBLUE      	 0X01CF	//深蓝色
	#define UGUI_COLOR_LIGHTBLUE      	 0X7D7C	//浅蓝色  
	#define UGUI_COLOR_GRAYBLUE       	 0X5458 //灰蓝色
	//以上三色为PANEL的颜色 
	#define UGUI_COLOR_LIGHTGREEN     	 0X841F //浅绿色
	#define UGUI_COLOR_LGRAY 			 0XC618 //浅灰色(PANNEL),窗体背景色
	#define UGUI_COLOR_LGRAYBLUE        0XA651 //浅灰蓝色(中间层颜色)
	#define UGUI_COLOR_LBBLUE           0X2B12 //浅棕蓝色(选择条目的反色)	
#elif (UGUI_COLOR_DATA_BITS == 18)

#elif (UGUI_COLOR_DATA_BITS == 24)

#elif (UGUI_COLOR_DATA_BITS == 32)
#endif

/* display default config	*/
#define UGUI_DEFAULT_FRONT_COLOR		UGUI_COLOR_BLACK
#define UGUI_DEFAULT_BACK_COLOR		UGUI_COLOR_WHITE
#define UGUI_DEFAULT_FONTSIZE	UGUI_FONT_Size_16
